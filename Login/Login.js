...
function displaylogin() {
    ...
    API.setCefBrowserPosition(myBrowser, 300, 150); //The orientation (top left) corner in relation to the user's screen.  This is useful if you do not want a full page browser.  0,0 is will lock the top left corner of the browser to the top left of the screen.
...
function register(Password) {
    ...
    API.triggerServerEvent("PlayerRegister", Password);
}
